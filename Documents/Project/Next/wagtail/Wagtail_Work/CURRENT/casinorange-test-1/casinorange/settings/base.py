...
THIRD_PARTY_APPS = ["compressor", "django_extensions", "wagtailfontawesome"]
...
WSGI_APPLICATION = "casinorange.wsgi.application"
...
# Sets custom models for Document and Images
